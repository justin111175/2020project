...
LoadScene::LoadScene()
{
	...
	IpSceneMng._chipType.first = CHIP_TYPE::êX3;
	//if (IpSceneMng._chipType.second == CHIP_TYPE::êX1)
	//{
	//	IpSceneMng._chipType.first = CHIP_TYPE::êX2;
	//}
	//else if (IpSceneMng._chipType.second == CHIP_TYPE::êX2)
	//{
	//	IpSceneMng._chipType.first = CHIP_TYPE::êX3;
	//}
